...
from hummingbot.connector.exchange.binance_m import binance_constants as CONSTANTS, binance_web_utils as web_utils
from hummingbot.connector.exchange.binance_m.binance_m_order_book import BinanceOrderBook
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.binance_m.binance_m_exchange import BinanceExchangeM
